<script lang="ts">
	...
	function makeThumbnail() {
		...
		if (!processRunning) {
			...
			html2canvas(wrapper, {
				ignoreElements: function (el: Element) {
					return el.classList.contains('toExcludeFromSnapshot');
				},
				scale: 0.1,
				logging: false
			})
	...
	function takeshot(): void {
		let bgColor = '#f0f9ff'; //bg-sky-50 https://tailwindcss.com/docs/colors
