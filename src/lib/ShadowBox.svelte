...
<div class="ShadowBoxBG" class:hidden onclick={closeComponent} onkeydown={closeComponent} role="button" tabindex="0"></div>
<div id={id} class="ShadowBox bg-sky-50 dark:bg-gray-700 p-4" 
    ...
    <div class="ShadowClosing">
        ...
        <span class='pointer font-bold' onclick={closeComponent} onkeydown={closeComponent} role="button" tabindex="0">
