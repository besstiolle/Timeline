<script lang="ts">
    ...
    let xMilestonePosition =  (milestone.date.getTime() - start.getTime()) / (end.getTime() - start.getTime()) * Constantes.GridConstantes.MIDDLE_WIDTH
</script>
...
<use x="{xMilestonePosition - 10}" y="0" href="#M{i}"/>