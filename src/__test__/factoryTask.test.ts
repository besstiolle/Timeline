...
describe('test factoryCards', () => {
    const task: Struct.Task = new Struct.Task(1,"label","2020-01-01", "2020-01-02", true , 99, true, "Swim1", 10)
...
describe('FactoryTask.getById', () => {
    const task1 = new Struct.Task(1,"label 1", "2022-01-01", "2022-02-01",true, 100, true, "Swimline 1", 5)
    const task2 = new Struct.Task(2,"label 2", "2022-01-01", "2022-02-01",true, 100, true, "Swimline 1", 5)
    const task3 = new Struct.Task(3,"label 3", "2022-01-01", "2022-02-01",true, 100, true, "Swimline 1", 5)
    const task4 = new Struct.Task(4,"label 4", "2022-01-01", "2022-02-01",true, 100, true, "Swimline 1", 5)
