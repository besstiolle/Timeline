...
test("Helpers.countVisibleTasksInMap with all visible tasks", ()=> {
    expect(Helpers.countVisibleTasksInList(mapAllVisible)).toBe(3)
})
mapAllHidden[task4.id] = task4
mapAllHidden[task5.id] = task5
test("Helpers.countVisibleTasksInMap with all hidden tasks", ()=> {
...
test("Helpers.countVisibleTasksInMap with mixed tasks", ()=> {
    expect(Helpers.countVisibleTasksInList(mapAllMixed)).toBe(3)
})

test("Helpers.countVisibleTasksInMap with no task", ()=> {
