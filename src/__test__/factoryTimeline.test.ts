...
describe('test FactoryTimeline.addTask', () => {
    ...
    FactoryTimeline.addTask(timeline, new Task(1,"label 1", date1, date2, true, 100, true, "Swimline 1", 5))
    FactoryTimeline.addTask(timeline, new Task(2,"label 2", date1, date2, true, 100, true, "Swimline 1", 5))
    FactoryTimeline.addTask(timeline, new Task(3,"label 3", date1, date2, true, 100, true, "Swimline 1", 5))
...
describe('test FactoryTimeline.refresh with differents dates', () => {
    const timeline1 = new Timeline("key", "title")
    timeline1.tasks.push(new Task(1,"label 1", "2020-01-01", "2020-01-31", true, 100, true, "Swimline 1", 5))
    ...
    const timeline2 = new Timeline("key", "title")
    timeline2.tasks.push(new Task(1,"label 1", "2020-01-15", "2020-03-01", true, 100, true, "Swimline 1", 5))
    ...
    timeline3a.tasks.push(new Task(1,"label 1", "2020-02-07", "2022-02-07", true, 100, true, "Swimline 1", 5))
    ...
    timeline3b.tasks.push(new Task(1,"label 1", "2020-02-17", "2022-02-17", true, 100, true, "Swimline 1", 5))
    ...
    timeline4.tasks.push(new Task(1,"label 1", "2020-01-15", "2040-02-01", true, 100, true, "Swimline 1", 5))
