...
function withTask(){
    ...
    let jsonExpected = '{"key":"key","title":"title","tasks":[{"id":1,"label":"label 1","dateStart":"2022-01-01","dateEnd":"2022-02-01","progress":100,"isShow":true,"swimline":"Swimline 1","swimlineId":5}],"milestones":[],"swimlines":[],"isInitiate":false,"start":null,"end":null,"maxId":0,"viewbox":"0 0 0 0","showAll":false}'
...
function withMilestone(){
    ...
    let jsonResult = JSON.stringify(timeline)
    let jsonExpected = '{"key":"key","title":"title","tasks":[],"milestones":[{"id":1,"label":"label 1","date":"2022-01-01","isShow":true}],"swimlines":[],"isInitiate":false,"start":null,"end":null,"maxId":0,"viewbox":"0 0 0 0","showAll":false}'
...
function withMetaTimelines(){
    ...
    let jsonResult = JSON.stringify(timeline)
    let jsonExpected = '{"key":"key","title":"title","tasks":[],"milestones":[],"swimlines":[],"isInitiate":true,"start":"2022-01-01","end":"2022-12-31","maxId":99,"viewbox":"viewbox","showAll":true}'
